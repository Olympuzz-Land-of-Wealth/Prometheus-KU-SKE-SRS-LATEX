...
\def \srsTitle{Prometheus: 

Computer Vision-Based Gym Machine Occupancy Detection and Spatial Analytics}
\def \srsAuthorOne{Phasit Ruangmak}
\def \srsAuthorTwo{Tanasatit Ngaosupathon}
\def \srsAuthorThree{}
\def \srsAcademicYear{xxxx}
