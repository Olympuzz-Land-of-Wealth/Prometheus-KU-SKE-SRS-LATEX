...
As illustrated in Figure \ref{fig:system-architecture}, the process begins at the edge to ensure low latency and privacy. Metadata is then pushed to the cloud to serve the analytical needs of gym owners and the real-time needs of members.
